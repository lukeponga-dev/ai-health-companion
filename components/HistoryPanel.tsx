  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-start">
      ...
      <div className="relative w-full max-w-[280px] md:max-w-xs bg-ui-panel h-full shadow-2xl flex flex-col animate-fade-in-left dark:bg-ui-dark-1 dark:text-white border-r border-ui-border dark:border-ui-dark-3 overflow-hidden">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-ui-border dark:border-ui-dark-3 bg-ui-bg dark:bg-ui-dark-2">
          <div className="flex items-center justify-between text-[10px] font-bold text-tertiary-38 uppercase tracking-widest px-1">
            <span>{conversations.length} Session{conversations.length !== 1 ? 's' : ''}</span>
            <span className="text-brand-success">Verified Secure</span>
          </div>
        </div>
      </div>
